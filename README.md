...
我们参考了过往的关于AlexNet论文[1]，在对比了LeNet[2]后，我们选择使用层数更多，同时具有更多连接的AlexNet，在搭建了具有5层卷积层和3层连接层的神经网络模型之后，我们对样本进行8:2的划分（8为训练集，2为测试集），其中测试集内具有1000张negativeID的图片和40张positiveID的图片
